...
public class Hormiga implements IHormiga {
    ...
    protected int x; // Coordenada x de la hormiga
    protected int y; // Coordenada y de la hormiga
    protected int tickCounter; // Contador de ticks
    protected Orientacion orientacion; // Orientación actual de la hormiga
