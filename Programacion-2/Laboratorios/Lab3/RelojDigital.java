...
public class RelojDigital {
  ...
  // Método para escribir la hora en modo gráfico
  ...
  // Método para probar la escritura de una hora en modo gráfico
  ...
  public static void main(String[] args) {
    // testGraficos(); // Descomenta para probar la escritura de una hora en modo gráfico
